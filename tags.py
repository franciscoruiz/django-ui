...
TODO:
 ...
 - Does the property 'resolve_parameters' belong to the block or to the tag?
...
class Tag(Node):
    ...
    def _parse_blocks(cls, parser, token):
        ...
        while(True):
            ...
            if block_processor._resolve_parameters:
...
def tag_block(name=None, next_blocks=None, resolve_parameters=True):
    """
    Declare a tag block.
    ...
    def _actual_wrapper(processor):
        ...
        processor_wrapper._resolve_parameters = resolve_parameters
